...
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        this.abat= this.physics.add.sprite(game.config.width / 2,35, "bat");
        this.wbat= this.physics.add.sprite(game.config.width / 2,1300, "bat");
        this.abat.setImmovable(true);
        this.wbat.setImmovable(true);
    ...
    update(){
            ...
            this.physics.world.collide(this.ball, this.wbat, function(){
                this.ball.body.velocity.y = gameOptions.ballPower * (this.isUnderwater() ? -2 : 2);
                }, null, this);
            this.physics.world.collide(this.ball, this.abat, function(){
                this.ball.body.velocity.y = gameOptions.ballPower  * (this.isUnderwater() ? -2 : 2);
                }, null, this);
